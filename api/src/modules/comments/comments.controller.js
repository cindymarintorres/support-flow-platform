...
var CommentsController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('tickets/:ticketId/comments')];
    ...
    var CommentsController = _classThis = /** @class */ (function () {
        ...
        CommentsController_1.prototype.create = function (ticketId, createCommentDto, req) {
            return this.commentsService.create(ticketId, req.user.id, createCommentDto);
        };
        CommentsController_1.prototype.findAll = function (ticketId) {
