...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var password, agentPassword, requesterPassword, admin, agent, requester, categories, _i, categories_1, cat;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt.hash('Admin1234!', 10)];
                case 1:
                    password = _a.sent();
                    return [4 /*yield*/, bcrypt.hash('Agent1234!', 10)];
                case 2:
                    agentPassword = _a.sent();
                    return [4 /*yield*/, bcrypt.hash('Requester1234!', 10)];
                case 3:
                    requesterPassword = _a.sent();
